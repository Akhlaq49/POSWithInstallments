...
const API_BASE_URL = process.env.REACT_APP_API_URL || 'http://192.168.1.8:5000/api/storefront';

// Media base URL for product images served by ReactPosApi
export const MEDIA_BASE_URL = process.env.REACT_APP_MEDIA_URL || 'http://192.168.1.8:5000';
