...
const ExpenseReport: React.FC = () => {
  ...
  const cols = ['Expense Name', 'Category', 'Description', 'Date', 'Amount', 'Status'];
  ...
  return (
    <>
      <PageHeader title="Expense Report" breadcrumbs={[{ title: 'Reports' }, { title: 'Expense Report' }]} />
      <div className="card">
        <div className="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            <ExportButtons onExportExcel={() => exportToExcel(cols, rows, 'expense-report')}
              onExportPDF={() => exportToPDF(cols, rows, 'expense-report', 'Expense Report', [
        ...
        <div className="card-body">
          {loading ? <div className="text-center py-5"><div className="spinner-border text-primary"></div></div> : (
            <>
              <div className="mb-3"><strong>Total Expense: </strong>Rs {totalExpense.toLocaleString(undefined, { minimumFractionDigits: 2 })}</div>
