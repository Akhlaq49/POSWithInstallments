...
const POSOrders: React.FC = () => {
  ...
  const extraParams = useMemo(() => {
    const p: Record<string, string> = { source: 'pos' };
          ...
          {loading ? (
            ...
            <div className="table-responsive">
              <table className="table datanew">
                ...
                <tbody>
                  {sales.length === 0 ? (
                    <tr><td colSpan={11} className="text-center py-4">No POS orders found</td></tr>
                  ) : sales.map((s) => (
                    <tr key={s.id}>
                      <td>
              ...
              <div className="page-header p-4 border-bottom mb-0">
                ...
                <div className="page-btn">
                  <button className="btn btn-secondary" onClick={() => setShowDetailModal(false)}>
                    <i data-feather="arrow-left" className="me-2"></i>Back to POS Orders
                  </button>
                </div>
              </div>
              <div className="card border-0 mb-0">
