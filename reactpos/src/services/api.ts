...
const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'http://192.168.1.4:5000/api';
export const MEDIA_BASE_URL = import.meta.env.VITE_MEDIA_BASE_URL || 'http://192.168.1.4:5000';
